...
import { Sparkles, Loader2, Send, Copy, Check, FolderHeart } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#090D16] text-white relative font-sans overflow-x-hidden selection:bg-[#7F00FF]/40">
      <Sidebar
